...
final class RegistryFactory {
    public static function make():ModuleRegistry{
        ...
        $defs=[
            ...
            ['safe-svg-upload','Safe SVG Upload','Sanitize SVG files before WordPress accepts the upload.','media',SafeSvgUpload::class,['svg','media','upload'],['admin','ajax','rest'],'medium',false,['classes'=>['DOMDocument']]],
            ...
            ['custom-frontend-css','Custom Frontend CSS','Add site-wide CSS without editing the active theme.','content',CustomFrontendCss::class,['css','frontend','design'],['frontend'],'medium',true,[]],
            ['custom-admin-css','Custom Admin CSS','Add wp-admin CSS without editing WordPress, plugins, or the theme.','admin',CustomAdminCss::class,['css','admin','design'],['admin'],'medium',true,[]],
            ...
            ['maintenance-mode','Maintenance Mode','Show visitors a 503 maintenance page while logged-in administrators keep access.','utilities',MaintenanceMode::class,['maintenance','503','site'],['frontend'],'medium',true,[]],
            ...
            ['order-amount-rules','Minimum / Maximum Order Amount','Set optional minimum and maximum cart totals for checkout.','woocommerce',OrderAmountRules::class,['woocommerce','checkout','minimum','maximum','compat:store-api'],['all'],'medium',true,['plugins'=>['woocommerce/woocommerce.php']]],
            ...
            ['buy-now','Buy Now Button','Add a Buy Now button that sends successful add-to-cart actions directly to checkout.','woocommerce',BuyNow::class,['woocommerce','conversion','checkout','compat:classic-checkout'],['frontend','ajax'],'low',false,['plugins'=>['woocommerce/woocommerce.php']]],
            ...
            ['fomo-sales-notifications','FOMO Sales Notifications','Build a daily snapshot of recent paid orders and use it for purchase notifications.','woocommerce',FomoSalesNotifications::class,['woocommerce','fomo','sales','notifications'],['all'],'medium',true,['plugins'=>['woocommerce/woocommerce.php']]],
            ['woocommerce-wishlist','Wishlist','Add a wishlist for guests and customers, including sharing and optional removal after purchase.','woocommerce',Wishlist::class,['woocommerce','wishlist','favorites'],['all'],'medium',true,['plugins'=>['woocommerce/woocommerce.php']]],
            ...
            ['whatsapp-enquiry','WhatsApp Product Enquiry','Add WhatsApp enquiry buttons with product details in the message.','woocommerce',WhatsappEnquiry::class,['woocommerce','whatsapp','enquiry'],['frontend'],'low',true,['plugins'=>['woocommerce/woocommerce.php']]],
            ...
            ['auto-apply-coupon','Auto Apply Coupon','Automatically apply a configured WooCommerce coupon in cart and checkout.','woocommerce',AutoApplyCoupon::class,['woocommerce','coupon','discount','compat:store-api'],['frontend','rest','ajax'],'medium',true,['plugins'=>['woocommerce/woocommerce.php']]],
            ...
            ['direct-checkout','Direct Checkout','Send standard add-to-cart actions straight to checkout.','woocommerce',DirectCheckout::class,['woocommerce','checkout','conversion','compat:classic-checkout'],['frontend','ajax'],'medium',true,['plugins'=>['woocommerce/woocommerce.php']]],
            ['checkout-field-controls','Checkout Field Controls','Hide selected classic checkout fields and control billing phone requirement.','woocommerce',CheckoutFieldControls::class,['woocommerce','checkout','fields','compat:classic-checkout'],['frontend'],'medium',true,['plugins'=>['woocommerce/woocommerce.php']]],
            ...
            ['checkout-text-customizer','Checkout Text Customizer','Customize classic checkout button text and selected field placeholders.','woocommerce',CheckoutTextCustomizer::class,['woocommerce','checkout','labels','compat:classic-checkout'],['frontend'],'low',true,['plugins'=>['woocommerce/woocommerce.php']]],
            ...
            ['custom-order-statuses','Custom Order Statuses','Add custom WooCommerce order statuses from a slug and label.','woocommerce',CustomOrderStatuses::class,['woocommerce','orders','status'],['all'],'medium',true,['plugins'=>['woocommerce/woocommerce.php']]],
            ['security-headers','Security Headers','Send a small set of HTTP security headers from WordPress.','security',SecurityHeaders::class,['security','headers','http'],['all'],'medium',true,[]],
            ['redirect-manager','Redirect Manager','Create local 301 redirects from old paths to new paths.','utilities',RedirectManager::class,['redirects','seo','404'],['frontend'],'medium',true,[]],
            ['404-tracker','404 Tracker','Log recent 404 URLs with hit counts, last-seen time, and referrers.','utilities',NotFoundTracker::class,['404','seo','tracking'],['frontend','admin'],'low',true,[]],
            ['admin-menu-organizer','Admin Menu Organizer','Choose which wp-admin menus and submenus client administrators can see.','admin',AdminMenuOrganizer::class,['admin menu','organizer','client admin'],['admin'],'medium',false,[]],
            ['protected-owner','Protected Owner','Protect selected administrator accounts from changes made by other administrators.','admin',ProtectedOwner::class,['owner','admin','protection','white label'],['all'],'high',false,[]],
            ...
            ['reading-time','Reading Time','Add a reading-time shortcode with configurable speed and label.','content',ReadingTime::class,['reading time','content','shortcode'],['all'],'low',true,[]],
            ...
            ['critical-plugin-protection','Critical Plugin Protection','Prevent other administrators from deactivating selected plugins and exclude them from automatic updates.','admin',CriticalPluginProtection::class,['plugins','protection','updates'],['admin'],'high',true,[]],
            ...
            ['plugin-update-freeze','Plugin Update Freeze','Turn off automatic updates for selected plugins and limit manual updates to Protected Owners.','admin',PluginUpdateFreeze::class,['plugins','updates','freeze','owner'],['admin'],'high',true,[]],
            ...
            ['empty-cart-button','Empty Cart Button','Add a nonce-protected Empty Cart button to the classic WooCommerce cart.','woocommerce',EmptyCartButton::class,['woocommerce','cart','button','compat:classic-checkout'],['frontend'],'low',true,['plugins'=>['woocommerce/woocommerce.php']]],
            ...
            ['activity-log-lite','Activity Log Lite','Keep a recent local history of logins, plugin/theme changes, and content saves.','admin',ActivityLogLite::class,['activity','audit','log'],['all'],'medium',true,[]],
            ...
            ['mail-log','Mail Log','Log recent WordPress mail attempts and failures.','email',MailLog::class,['email','mail','log'],['all'],'medium',true,[]],
