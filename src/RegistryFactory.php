...
final class RegistryFactory {
    public static function make():ModuleRegistry{
        ...
        $defs=[
            ...
            ['direct-checkout','Direct Checkout','Redirect ordinary add-to-cart actions directly to checkout.','woocommerce',DirectCheckout::class,['woocommerce','checkout','conversion','compat:classic-checkout'],['frontend','ajax'],'medium',true,['plugins'=>['woocommerce/woocommerce.php']]],
