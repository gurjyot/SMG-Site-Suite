...
final class RegistryFactory {
    public static function make():ModuleRegistry{
        ...
        $defs=[
            ...
            ['direct-checkout-links',__('Direct Checkout Links','smg-site-suite'),__('Generate campaign links that add a selected product and quantity, optionally clear the cart, and go straight to checkout.','smg-site-suite'),'woocommerce',DirectCheckoutLinks::class,['woocommerce',__('checkout','smg-site-suite'),__('links','smg-site-suite'),'campaigns'],['all'],'medium',true,['plugins'=>['woocommerce/woocommerce.php']]],
            ['url-coupons',__('URL Coupons','smg-site-suite'),__('Apply WooCommerce coupons from a configurable URL parameter with optional cart or checkout redirect.','smg-site-suite'),'woocommerce',UrlCoupons::class,['woocommerce','coupon','url'],['frontend'],'medium',true,['plugins'=>['woocommerce/woocommerce.php']]],
