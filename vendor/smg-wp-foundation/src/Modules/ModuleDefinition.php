...
final class ModuleDefinition {
    ...
    private array $tags; private array $dependencies; private array $contexts; private string $risk; private bool $hasSettings; private bool $defaultEnabled; private string $settingsMode;
    public function __construct(array $definition){
        ...
        $this->risk=$risk;$this->hasSettings=(bool)($definition['has_settings']??false);$this->defaultEnabled=(bool)($definition['default_enabled']??false);$mode=strtolower((string)($definition['settings_mode']??'drawer'));$this->settingsMode=in_array($mode,['drawer','page'],true)?$mode:'drawer';
    }
    ...
    public function hasSettings():bool{return $this->hasSettings;} public function defaultEnabled():bool{return $this->defaultEnabled;} public function settingsMode():string{return $this->settingsMode;}
}
